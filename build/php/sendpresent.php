<?php
$sendto = "kotolapoff@mail.ru, alex_z@mail.franch5.ru, zvnfranch5@yandex.ru, franchaizing-5@yandex.ru";
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Письмо с сайта Котолапофф</h2>\r\n";
